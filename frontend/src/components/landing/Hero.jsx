...
import { ArrowRight, MessageSquareText, Radio } from "lucide-react";
    ...
    <div className="relative max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-2 gap-16 lg:gap-12 items-center">
      ...
      >
        ...
        <h1
          ...
          className="text-[40px] leading-[1.05] md:text-[56px] lg:text-[64px] font-bold tracking-tight text-[#111827]"
        >
          Macro, FX, and intermarket analysis — delivered directly to WhatsApp.
        </h1>
      ...
      <motion.div
        ...
        className="relative"
      >
        {/* Market dashboard card (behind) */}
        <div
          data-testid="hero-market-dashboard"
          className="absolute z-20 -top-8 -right-2 lg:-right-6 w-56 bg-[#09090B] rounded-xl border border-white/10 p-4 shadow-2xl hidden sm:block"
        >
        ...
        <div
          ...
          className="relative z-10 max-w-md mx-auto lg:mx-0 lg:mt-12 bg-white rounded-2xl border border-[#E4E4E7] shadow-xl shadow-black/[0.06] overflow-hidden transition-transform duration-300 hover:-translate-y-1"
        >
          {/* Card header */}
          ...
          <div className="p-5">
            <div className="bg-[#F4F4F5] rounded-xl rounded-tl-sm p-4 border border-[#E4E4E7]">
              <p className="text-[15px] leading-relaxed text-[#111827]">
                Gold and silver remain supported as yields soften and USD momentum fades. Watch XAG
