...
const FloatingAd = ({ ad }) => {
  ...
  return (
    <div
      ...
      className="relative bg-white rounded-xl border border-[#E4E4E7] shadow-lg overflow-hidden"
    >
...
export const FloatingAds = () => (
  <aside
    data-testid="floating-ads"
    className="hidden xl:flex flex-col gap-4 fixed right-5 top-1/2 -translate-y-1/2 z-40 w-60"
